function socials() {
    let parent = Object.assign(document.createElement("div"), {className: "socials", style: "visibility: hidden; max-height: 0; overflow: hidden;"}),
        ...
        socialItem2 = Object.assign(document.createElement("a"), {className: "socials-item two", href: "//discord.gg/cSuzxF6ece", innerHTML: "<img src=\"img/dc.png\">"}),
        socialItem3 = Object.assign(document.createElement("a"), {className: "socials-item three", href: "//g01iath.bandcamp.com", innerHTML: "<img src=\"img/bc.png\">"}),
